...
<!--//end-search-box-->
		...
		<div id="page-wrapper">
			<div class="search-box">
					<form class="input" action="find_student.php" method="POST" >
						<input class="sb-search-input input__field--madoka" placeholder="Search..." type="search" id="input-31" name="search_id" /> 
 ...
 $db = mysqli_connect("localhost", "root", "", "akhil");
    ...
    $msg = "";
error_reporting(0);
  $search_id=mysqli_real_escape_string($db, $_POST['search_id']);
// Check connection
...
$result = mysqli_query($db,"SELECT * FROM member where username='$search_id'");
$teacher_member_result=mysqli_query($db,"SELECT * FROM teacher_member where username='$search_id'");
...
echo "<thead>";
echo "<tr>";
echo "<th>NAME OF THE PERSON</th>";
echo "<th>VIEW</th>";
echo "</tr>";
echo "<tr>";

echo "<td>" . $row['fname'] . "</td>";
echo "<td>" ."<a href='tstudent_details_sem.php?id=".$row['username']."'><h4 class='media-heading''> click </h4></a>". "</td>";
...
echo "<td>" . $row['fname'] . "</td>";
echo "<td>" ."<a href='teacher_details.php?id=".$row['username']."'><h4 class='media-heading''> click </h4></a>". "</td>";
