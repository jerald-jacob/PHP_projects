          ...
          <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="moodile_course_sub_registration.php"><i class="fa fa-angle-right"></i> Course Subject Add</a></li><li><a href="view_course.php"><i class="fa fa-angle-right"></i>View Course</a></li>
...
<?php
    			  if(isset($_GET['id']))
    			  {
     			 	echo " <label style='color:red;text-align: center; width:100%; font-size:15px;'>Allready a Student is using this user id please select another one</label>	";
     		 unset($_GET['id']);
    			  }
  				  ?>	<?php
    			  if(isset($_GET['msg']))
...
<input type="text" class="form-control" name="username" placeholder="use numberic and latters" required=""></div>
<div class="form-group"> 
...
<input type="text" class="form-control" name="phnumber" placeholder="Contact Number" pattern="[7-9]{1}[0-9]{9}" required=""></div>
	<div class="form-group">
...
<label for="exampleInputPassword1">Semister</label>
		 <select name="sem" class='form-control1'>
...
<input type="text" class="form-control" name="password" placeholder="password name" required=""></div>
