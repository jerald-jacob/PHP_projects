...
<body class="cbp-spmenu-push">
    ...
    $db = mysqli_connect("localhost", "root", "", "akhil");
      $event = mysqli_query($db, "SELECT * FROM `event` ORDER BY `event`.`id` DESC ");
    
       
    while ($row = mysqli_fetch_array($event)) {
                  echo "  <p class='media-heading'style='font-family:Serif;color:#3399ff;font-size:20px;'> ".$row['event_name']."  </p>";
     echo " ".$row['details']."";
