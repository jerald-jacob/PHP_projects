	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">Course Registration</h2>
...
<div class="form-body">
	<?php
    			  if(isset($_GET['id']))
    			  {
     			 	echo " <label style='color:red;text-align: center; width:100%; font-size:15px;'>Allready a Course is using this user id please select another one</label>	";
     		 unset($_GET['id']);
    			  }
  				  ?>	<?php
    			  if(isset($_GET['msg']))
     		 ...
     		 unset($_GET['id']);
  				  ...
  				  ?>
<form name="reg" action="course_code.php" onsubmit="return validateForm()" method="post">
	<div class="form-group"> 
<label for="exampleInputEmail1"> course_id</label>
<input type="text" class="form-control" name="course_id" placeholder="Course name" required=""></div>
<div class="form-group"> 
<label for="exampleInputEmail1">Course Name</label>
<input type="text" class="form-control" name="cname" placeholder="Course name" required=""></div> 
<div class="form-group">
<label for="exampleInputPassword1">Department</label>
<input type="text" class="form-control" name="Department" placeholder="Departmet" required="">
</div>
<div class="form-group"> 
<label for="exampleInputFile">Semister</label> 
<input type="text" class="form-control" name="sem" placeholder="Semister" required="">
</div> <input name="submit" class="btn btn-default" type="submit" value="Submit" />
  </form> 
