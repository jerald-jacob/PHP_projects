	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
           ...
           <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="view_course.php"><i class="fa fa-angle-right"></i>View Course</a></li>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">Subject Registration</h2>
...
<div class="form-body">
	<?php
    			  if(isset($_GET['id']))
    			  {
     			 	echo " <label style='color:red;text-align: center; width:100%; font-size:15px;'>Allready a Subject is using this id please select another one</label>	";
     		 unset($_GET['id']);
    			  }
  				  ?>	<?php
    			  if(isset($_GET['msg']))
    			  {
     			 	echo " <label style='color:green;text-align: center; width:100%; font-size:30px;'>success</label>	";
     		 unset($_GET['id']);
    			  }
  				  ?>
<form name="reg" action="course_subject_add_code.php" onsubmit="return validateForm()" method="post">
<div class="form-group"> 
<label for="exampleInputEmail1">Subject Id</label>
<input type="text" class="form-control" name="subject_id" placeholder="subject name" required=""></div>
<div class="form-group"> 
...
echo "<td> <select name='department' class='form-control1'>";
...
$result = mysqli_query($db,"SELECT * FROM course");
echo "<td> <select name='course' class='form-control1'>";
while($row = mysqli_fetch_array($result))
{
...
<input type="text" class="form-control" name="subject" placeholder="subject name" required=""></div>


<div class="form-group">
<label for="exampleInputPassword1">Semister</label>
<select name="semister" class="form-control1">
...
<div class="form-group">
	<label for="exampleInputEmail1">Select Teacher and Id</label>
...
$result = mysqli_query($db,"SELECT * FROM teacher_member ");
echo "<td> <select name='teacher' class='form-control1'>";
while($row = mysqli_fetch_array($result))
{
$VALUE=$row['fname'];
