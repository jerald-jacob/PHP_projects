 <?php
  ...
  if (isset($_POST['latest_upload'])) {
        ...
        $event_details= mysqli_real_escape_string($db, $_POST['event_details']);
       
        
        $sql = "INSERT INTO event (event_name,details,image) VALUES ('$event_name','$event_details','$latest_image')";
        mysqli_query($db, $sql);
            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="moodile_course_sub_registration.php"><i class="fa fa-angle-right"></i> Course Subject Add</a></li><li><a href="view_event.php"><i class="fa fa-angle-right"></i> View Events</a></li>
...
<div class="form-body"><form method="POST" action="event.php" enctype="multipart/form-data" class="contact_form">
<div class="form-group"> 
<label for="exampleInputEmail1">Event Name</label>
<input type="text" class="form-control" name="event_name" placeholder="Course name" required=""></div> 
<div class="form-group">
<label for="exampleInputPassword1">Details</label>
<input type="text" class="form-control" name="event_details" placeholder="Departmet" required="">
</div>
<div class="form-group"> 
<label for="exampleInputFile">file</label> 
<input class="form-control"  type="file" name="latest_image">
</div>  <input type="submit" name="latest_upload" class="btn btn-default" value="Submit">
