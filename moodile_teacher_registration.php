...
<div class="form-body">
	<?php
    			  if(isset($_GET['id']))
    			  {
     			 	echo " <label style='color:red;text-align: center; width:100%; font-size:15px;'>Allready a Teacher is using this user id please select another one</label>	";
     		 unset($_GET['id']);
    			  }
  				  ?>	<?php
    			  if(isset($_GET['msg']))
     		 ...
     		 unset($_GET['id']);
  				  ...
  				  ?>
<form name="reg" action="teacher_code.php" onsubmit="return validateForm()" method="post">
