...
<h2 class="title1">Teachers Contacts</h2>
...
$result = mysqli_query($db,"SELECT * FROM `teacher_member` ORDER BY `phnumber` ASC");
$teacher_member_result=mysqli_query($db,"SELECT member.fname , member.phnumber FROM (teacher_member,member)");
...
?>
			...
			<h2 class="title1">Students Contacts</h2>
...
$result = mysqli_query($db,"SELECT * FROM `member` ORDER BY `username` ASC");
$teacher_member_result=mysqli_query($db,"SELECT member.fname , member.phnumber FROM (teacher_member,member)");
echo "<table class='table'>";
echo "<thead>";
echo "<tr>";
